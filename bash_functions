...
hdv() {
  ...
  then
    ...
    tmux new-window     -t hb-dev:8 -n console -c ~/Development/code/handy/handybook
...
hsv() {
  ...
  then
    ...
    tmux new-window     -t hb-server:8 -n server  -c ~/Development/code/handy/handybook
    tmux new-window     -t hb-server:9 -n ssh     -c ~/Development/code/handy/handybook
